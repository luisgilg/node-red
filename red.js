...
if (parsedArgs.settings) {
    ...
    } else if (process.env.HOMEPATH && fs.existsSync(path.join(process.env.HOMEPATH,".config.json"))) {
        // Consider compatibility for older versions
        settingsFile = path.join(process.env.HOMEPATH,auxPath,"settings.js");
    } else {
        var userDir = parsedArgs.userDir || path.join(process.env.HOME || process.env.USERPROFILE || process.env.HOMEPATH);
